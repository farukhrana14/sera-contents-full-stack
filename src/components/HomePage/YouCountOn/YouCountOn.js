          ...
          <div className='d-flex justify-content-around'>
            ...
            <div className='row'>
                ...
                <div className='count-div col-md-4 col-12 p-5 border'>
                    ...
                    <CountUp style={{fontSize: '4rem', fontWeight: '600', color: 'white'}} end={5000} duration={5}/><span style={{fontSize: '4rem', fontWeight: '600', color: 'white'}} >+</span>
                   
                    <p style={{fontSize: '1.2rem', fontWeight: '400', color: 'white'}}>US Based Writers</p>
                </div>
                <div className='col-md-4 col-12 p-5 border'>
                    <CountUp style={{fontSize: '4rem', fontWeight: '600', color: 'white'}} end={6000} duration={5} /><span style={{fontSize: '4rem', fontWeight: '600', color: 'white'}}>+</span>
                    <p style={{fontSize: '1.2rem', fontWeight: '400', color: 'white'}}>Business Served</p>

                </div>
                <div className='col-md-4 col-12 p-5 border' >
                    <CountUp style={{fontSize: '4rem', fontWeight: '600', color: 'white'}} end={100} duration={6}/><span style={{fontSize: '4rem', fontWeight: '600', color: 'white'}}>M+</span>
